document.addEventListener('DOMContentLoaded', function () {
  ...
  baseStyle.textContent = [
    ...
    '[dir="rtl"] .' + ANIMATION_CLASS + '{transform:translateY(30px);}',
    '[dir="rtl"] .' + ANIMATION_CLASS + '.' + VISIBLE_CLASS + '{transform:translateY(0);}'
  ].join('');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "ELUP uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
      ...
      "es": {
        "consentModal": {
          ...
          "description": "ELUP utiliza cookies para mejorar tu experiencia, analizar el uso del sitio y ayudar en nuestros esfuerzos de marketing.",
      ...
      "fr": {
        "consentModal": {
          ...
          "description": "ELUP utilise des cookies pour améliorer votre expérience, analyser l'utilisation du site et nous aider dans nos efforts marketing.",
      ...
      "de": {
        "consentModal": {
          ...
          "description": "ELUP verwendet Cookies, um Ihr Erlebnis zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingbemühungen zu unterstützen.",
      ...
      "it": {
        "consentModal": {
          ...
          "description": "ELUP utilizza i cookie per migliorare la tua esperienza, analizzare l'utilizzo del sito e supportare le nostre attività di marketing.",
      ...
      "pt": {
        "consentModal": {
          "title": "Usamos cookies 🍪",
          "description": "ELUP usa cookies para melhorar sua experiência, analisar o uso do site e auxiliar em nossos esforços de marketing.",
      ...
      "nl": {
        "consentModal": {
          ...
          "description": "ELUP gebruikt cookies om uw ervaring te verbeteren, het sitegebruik te analyseren en onze marketinginspanningen te ondersteunen.",
      ...
      "he": {
        "consentModal": {
          ...
          "description": "ELUP משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
      ...
      "ar": {
        "consentModal": {
          ...
          "description": "يستخدم ELUP ملفات تعريف الارتباط لتحسين تجربتك وتحليل استخدام الموقع والمساعدة في جهودنا التسويقية.",
      ...
      "tr": {
        "consentModal": {
          ...
          "description": "ELUP, deneyiminizi geliştirmek, site kullanımını analiz etmek ve pazarlama çalışmalarımıza yardımcı olmak için çerezler kullanır.",
      ...
      "ru": {
        "consentModal": {
          ...
          "description": "ELUP использует файлы cookie для улучшения вашего опыта, анализа использования сайта и поддержки наших маркетинговых усилий.",
      ...
      "zh": {
        "consentModal": {
          "title": "我们使用 Cookie 🍪",
          "description": "ELUP 使用 Cookie 来改善您的体验、分析网站使用情况并协助我们的营销工作。",
          "acceptAllBtn": "全部接受",
      ...
      "ja": {
        "consentModal": {
          ...
          "description": "ELUPは、お客様の体験向上、サイト利用状況の分析、マーケティング活動の支援のためにCookieを使用しています。",
          "acceptAllBtn": "すべて許可",
      ...
      "ko": {
        "consentModal": {
          "title": "쿠키를 사용합니다 🍪",
          "description": "ELUP은(는) 경험 향상, 사이트 사용 분석 및 마케팅 활동 지원을 위해 쿠키를 사용합니다.",
          "acceptAllBtn": "모두 수락",
      ...
      "pl": {
        "consentModal": {
          ...
          "description": "ELUP używa plików cookie, aby poprawić Twoje wrażenia, analizować korzystanie z witryny i wspierać nasze działania marketingowe.",
      ...
      "uk": {
        "consentModal": {
          ...
          "description": "ELUP використовує файли cookie для покращення вашого досвіду, аналізу використання сайту та підтримки наших маркетингових зусиль.",
      ...
      "ro": {
        "consentModal": {
          ...
          "description": "ELUP folosește cookie-uri pentru a vă îmbunătăți experiența, a analiza utilizarea site-ului și a sprijini eforturile noastre de marketing.",
      ...
      "bg": {
        "consentModal": {
          ...
          "description": "ELUP използва бисквитки, за да подобри вашето изживяване, да анализира използването на сайта и да подпомогне маркетинговите ни усилия.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '44ef0f5a-409e-4bda-94db-d43a3245ff46',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '44ef0f5a-409e-4bda-94db-d43a3245ff46';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '44ef0f5a-409e-4bda-94db-d43a3245ff46';
